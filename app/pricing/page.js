...
const plans = [
  {
    ...
    features: [
      ...
      { text: 'Brain Dump synthesis', included: false },
      { text: 'Remy AI assistant', included: false },
      { text: 'Tags & folders', included: false },
              ...
              <table className="w-full">
                ...
                <tbody>
                  {[
                    ...
                    { feature: 'AI summaries', free: 'Basic', pro: true, plus: true },
                    { feature: 'Key points extraction', free: false, pro: true, plus: true },
                    { feature: 'Brain Dump synthesis', free: false, pro: true, plus: true },
                    { feature: 'Remy AI assistant', free: false, pro: 'Standard', plus: 'Advanced' },
                    { feature: 'Tags & folders', free: false, pro: true, plus: true },
                    { feature: 'Action items', free: false, pro: true, plus: true },
